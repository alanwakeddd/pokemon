...
Parameters are choosing by observation. Random select a range of npc, c, gamma at first. Then, change the range by observing the color map until showing local maximum.
Results: <br />
